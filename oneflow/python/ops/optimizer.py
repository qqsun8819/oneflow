...
class PiecewiseConstantScheduler(LrScheduler):
    ...
    def learning_rate_decay_conf(
        ...
        for values in self.values:
            learning_rate_decay_conf.mutable_piecewise_constant_conf().add_values(values)
        return learning_rate_decay_conf
...
class PiecewiseScalingScheduler(LrScheduler):
    ...
    def learning_rate_decay_conf(
        ...
        learning_rate_decay_conf.mutable_piecewise_scaling_conf.set_scales(self.scale)
        return learning_rate_decay_conf
